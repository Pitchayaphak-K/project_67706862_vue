  ...
  export default {
    ...
    let editModal;                  //เพิ่ม
      ...
      const fetchStudents = async () => {
        try {
          const response = await fetch("http://localhost/project_67706862_vue/api_php/api_student.php", {
            method: "GET",
            headers: {
...
// เพิ่มฟังก์ชั่นการแก้ไขข้อมูล ***
    const updateStudent = async () => {
      try {
        const response = await fetch("http://localhost/project_67706862_vue/api_php/show_student.php", {
          method: "PUT",
