...
export default {
  ...
  setup() {
    ...
    const fetchCustomers = async () => {
      try {
        const response = await fetch("http://localhost/project_67706862_vue/api_php/customer_crud.php", {
          method: "GET",
...
// เพิ่มฟังก์ชั่นการแก้ไขข้อมูล ***
    const updateCustomer = async () => {
      try {
        const response = await fetch("http://localhost/project_67706862_vue/customer_crud.php", {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
